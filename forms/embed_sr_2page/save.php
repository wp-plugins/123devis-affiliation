<?php 	
	...
	$saveable_data['parameters']['text_above_issue_questions'] = stripslashes_deep($_REQUEST['text_above_issue_questions']);
	$saveable_data['parameters']['text_above_user_questions'] = stripslashes_deep($_REQUEST['text_above_user_questions']);
